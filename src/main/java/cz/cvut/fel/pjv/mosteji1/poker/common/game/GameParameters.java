...
public abstract class GameParameters {
    ...
    public static String[] names = {"Jirka", "Vojta", "Sam", "Jakub", "Petr", "Martin", "David", "Tomas", "Jan", "Lukas", "Marek", "Jana", "Eva", "Katerina", "Petra", "Lucie", "Barbora", "Veronika", "Kristyna", "Monika", "Tereza", "Láďa"};
